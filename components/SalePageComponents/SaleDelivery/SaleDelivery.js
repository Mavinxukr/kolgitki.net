...
const SaleDelivery = () => (
  <>
    ...
    <div className={Styles.SaleDelivery}>
      <label htmlFor="deliveryOpen" className={Styles.SaleDelivery__ControllerTitle}>Доставка</label>
      <div className={Styles.SaleDelivery__Content}>
        <div className={Styles.SaleDelivery__RadioButtons}>
          ...
          <label htmlFor="postMan" className={Styles.SaleDelivery__Controller}><span className={Styles.SaleDelivery__ControllerBlock} /> Новая Почта</label>
          <input className={Styles.SaleDelivery__Field} type="radio" name="selectDelivery" id="postOffice" />
          <label htmlFor="postOffice" className={Styles.SaleDelivery__Controller}><span className={Styles.SaleDelivery__ControllerBlock} /> Новая Почта адрес</label>
        ...
        <div className={Styles.SaleDelivery__Selectors}>
          <div className={Styles.SaleDelivery__SelectorsGroup}>
